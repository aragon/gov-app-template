import { addressUtils, DataList, DocumentParser, Link, useOdsModulesContext } from "@aragon/ods";
 ...
 */
export const ProposalDataListItemStructure: React.FC<
  IProposalDataListItemStructureProps & { className?: string; href?: string }
> = (props) => {
  const {
    wagmiConfig: config,
    chainId,
  ...
  return (
    <DataList.Item className={classNames("flex flex-col gap-y-2", className)} {...otherProps}>
      ...
      <div className="flex flex-col gap-y-1">
        ...
        <DocumentParser className="line-clamp-2 leading-normal text-neutral-500 md:text-lg" document={summary} />
      </div>
